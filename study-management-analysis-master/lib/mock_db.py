...
class Database(object):
    ...
    def get_participants(self):
        if self.data_lib['alp']:
            ...
            df = pd.read_csv(self.data_lib['participants'], sep='t')
